module.exports = (function(){
  ...
  Pusher.prototype.stats = function(callback) {
    ...
    var request = client.request(this.options.method, this.path());
  ...
  Pusher.prototype.send = function(callback) {
    ...
    var request = client.request('POST', this.path(), {
      ...
      'Content-Length': new Buffer(this.data).length
    });
  ...
  Pusher.prototype.hash = function() {
    return crypto.createHash('md5').update(this.data, 'utf8').digest("hex");
  }
